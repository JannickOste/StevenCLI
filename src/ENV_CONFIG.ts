...
const ENV_CONFIG: IENV_CONFIG = {name: "steven", version: "0.6.0", description: "A Domain driven CLI service to assist you with all your needs ", author: "", projectRoot: "D:\\Workspace\\Typescript\\steven", sourceDir: "src", buildDir: "dist"}
